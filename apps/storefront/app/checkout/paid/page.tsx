...
export default async function PaidPage({
  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-16 text-center">
      <h1 className="text-xl font-black text-green-700">پرداخت موفق</h1>
      ...
      <div className="mt-6 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
        <Link href={`/order/${order ?? ""}`} className="inline-flex h-11 items-center rounded-full bg-primary px-6 text-sm font-bold text-white">
          پیگیری سفارش
        </Link>
